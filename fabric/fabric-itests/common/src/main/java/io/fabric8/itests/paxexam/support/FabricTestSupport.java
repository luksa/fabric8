...
public class FabricTestSupport extends FabricKarafTestSupport {
    ...
    protected Option[] fabricDistributionConfiguration() {
        return new Option[] {
                ...
                KarafDistributionOption.editConfigurationFilePut("fabric/import/fabric/profiles/default.profile/org.ops4j.pax.logging.properties", "log4j.appender.out.file", "${karaf.home}/data/log/karaf-${karaf.name}.log"),
